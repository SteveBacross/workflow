...
public class ValidationDmdPanel extends Panel {
...
//    private String ligneBudg;
//    private String ligneBudgetaire;

    private Long idDemande = 0L;

    public ValidationDmdPanel(String id) {
        super(id);
        addComponents();
    }
...
//                TextField ligneBudgetaire = new TextField("ligneBudgetaire");
//                formLigneBudget.add(ligneBudgetaire);
//                System.out.println(ligneBudg);
        ...
        LoadableDetachableModel detachableModel = new LoadableDetachableModel() {
            ...
            protected Object load() {
                ...
                try {
                    ...
                    list = demandeHttpClient.listDmdMateriel();
